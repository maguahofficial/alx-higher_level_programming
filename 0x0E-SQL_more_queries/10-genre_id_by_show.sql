-- This lists all the shows contained in hbtn_0d_tvshows that have at least one genre linked
-- This lists all the rows of a database that have one column in common
